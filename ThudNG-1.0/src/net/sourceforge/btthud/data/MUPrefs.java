...
public class MUPrefs implements Cloneable {
    ...
    public Point				tac2Loc;
    public int					tac2SizeX;
    public int					tac2SizeY;
    ...
    public boolean bUse2Maps;
    public boolean bStopMapEvents;
    ...
    public void defaultPrefs()
    {
        ...
        tac2Loc = new Point(20 + mainSizeX, 10);
	...
	public Object clone () throws CloneNotSupportedException {
		...
		newObject.tac2Loc = (Point)tac2Loc.clone();
