...
public class PrefsDialog extends JDialog {
	...
	private AbstractButton useTwoMapsCheckBox;
	...
	private void createComponents () {
		...
		useTwoMapsCheckBox = new JCheckBox ("Use 2 Map Windows");
		windowTab.add(useTwoMapsCheckBox);
	...
	private void updateComponents () {
		...
		useTwoMapsCheckBox.setSelected(prefs.bUse2Maps);
	}
	...
	private void doSave () {
		...
		prefs.bUse2Maps = useTwoMapsCheckBox.isSelected();
